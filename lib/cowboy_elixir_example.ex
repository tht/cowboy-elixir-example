defmodule CowboyElixirExample do
  ...
  four arguments:
    ...
    * Protocol options for cowboy as a map.  This can be a very big structure
      because it includes you "middleware environment", which among other things
      includes your entire routing table. Here that is the only option we are
      specifying.
